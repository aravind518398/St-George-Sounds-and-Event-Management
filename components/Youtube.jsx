...
export default function Youtube() {
    ...
    return (
      <div className="w-full flex justify-center my-35">
        ...
        <div className={`w-full max-w-[450px] md:max-w-[600px] lg:max-w-[800px] aspect-video relative ${isLoading ? 'hidden' : ''}`}>
          <iframe
            ...
            allowFullScreen
          ></iframe>
          <div className="absolute -top-3 -left-3 w-8 h-8 bg-blue-500 rounded-full opacity-20"></div>
